...
## 💻 Part 2: Automated Hyprland Desktop Environment Setup

After completing the Arch Linux base installation and rebooting, log in with your user account and ensure you have an internet connection.

The entire Hyprland desktop environment setup is automated. You only need to download and run a single bootstrap script.

### Single-Step Automated Installation

Run the following command in your terminal. It will download the bootstrap script and execute it:

```bash
curl -L https://raw.githubusercontent.com/Dhiliban-R/Hypr-Arch/main/bootstrap.sh -o bootstrap.sh && chmod +x bootstrap.sh && ./bootstrap.sh
```
...
Once the script is complete, reboot your system to see the new Hyprland desktop environment.
