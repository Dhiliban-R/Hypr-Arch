# ===============================================================
# 🐧 Fixa's Final Unified Zsh Config (Arch Linux + WezTerm)
# ===============================================================
...
clean() {
    ...
    $HOME/.local/bin/system-cleanup

    # 2. User/Home Cleanup
    echo "🧼 Clearing user caches and trash..."
    rm -rf ~/.cache/paru/clone/*
    rm -rf ~/.cache/ms-playwright/*
    rm -rf ~/.local/share/Trash/*
    rm -rf ~/.npm/_npx ~/.npm/_cacache

    echo "✨ Cleaning Gemini internal history..."
    ...
    echo "🎉 All cleanup (Root + User) complete!"
}
...
# ===============================================================
# 🚀 SMART EDITING WIDGETS (Hybrid Fallback)
# ===============================================================
