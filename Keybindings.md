...
| `XF86AUDIOPREV` | Launch Playerctl Previous |

### 🐚 Shell (Zsh)

| Key Combination | Action |
| :--- | :--- |
| `ALT + S` | Smart Sudo (Toggle 'sudo' at start of line) |
...
| Key Combination | Action |
| :--- | :--- |
| `SUPER + MOUSE + RIGHT + DRAG` | resizewindow |
